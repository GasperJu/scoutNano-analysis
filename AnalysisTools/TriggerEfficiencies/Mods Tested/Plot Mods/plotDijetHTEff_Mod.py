...
def main(args):
    ...
    print('u')
    fdir = f.GetDirectory("InclusiveTrigNanoAOD")#"DijethtTrigAnalyzerNanoAOD")
    statOption = ROOT.TEfficiency.kFCP

    variables  = ["ht_inclusive", "pt_leading"]#"minv_1", "ht_1", "minv_2", "ht_2", "ptak8_2", "minv_3", "ht_3", "minv_4", "ht_4" ]
    ...
    for var in variables:
        ...
        for fs in args.formats:
            savename = f'/eos/home-j/jleite/SecFAILING/CMSSW_14_0_12/src/Boosted-Elisa/TriggerEfficiencies/plots/TrgEffs_DijetHT_{var}{fs}'
...
if __name__ == "__main__":
    ...
    YEAR          = "2024"
    # ----- Histograms name
    TRGROOTFILE   = "histosQCD_HT_400to600_InclusiveTrigNanoAOD.root"
...
#"/eos/home-j/jleite/SecFAILING/CMSSW_14_0_12/src/Boosted-Elisa/TEST_histos_DijetHTTrigNanoAOD.root" #"histos_DijetHTTrigNanoAOD.root"
    FORMATS       = ['.png', '.pdf']
