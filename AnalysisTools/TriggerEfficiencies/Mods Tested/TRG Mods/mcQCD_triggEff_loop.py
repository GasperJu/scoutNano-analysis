...
# multiprocessing attempt (CPU-bound task)
def process_data(input_value, output_value):
    """A function that performs a task with a given input."""
    print(f"Starting task for input: {input_value}")
    p = PostProcessor(
    ".",
    input_value,
    cut=preselection,
    ...
    noOut=True,
    histFileName=output_value,
    histDirName="InclusiveTrigNanoAOD"
    )
    #print("Name is "+str(input_value)+".root")
    p.run()
    print(f"Finished task for input: {input_value}, Result: {output_value}")
    return p

# concurrent attempt (I/O-bound task)
'''
def process_data(input_value, output_value): #Add preselection per bkg and names
...
#outputFile = 'histosWWto4Q_InclusiveTrigNanoAOD.root'
...
if __name__ == '__main__':
    ...
    inputs_list = [
#QCD_4Jets_Bin_HT_100to200, 
#(QCD_4Jets_Bin_HT_200to400, 'histosQCD_HT_200to400_InclusiveTrigNanoAOD.root'), (QCD_4Jets_Bin_HT_400to600, 'histosQCD_HT_400to600_InclusiveTrigNanoAOD.root')]
(QCD_4Jets_Bin_HT_600to800, 'histosQCD_HT_600to800_InclusiveTrigNanoAOD.root'), (QCD_4Jets_Bin_HT_800to1000, 'histosQCD_HT_800to1000_InclusiveTrigNanoAOD.root'), (QCD_4Jets_Bin_HT_1000to1200, 'histosQCD_HT_1000to1200_InclusiveTrigNanoAOD.root'), (QCD_4Jets_Bin_HT_1200to1500, 'histosQCD_HT_1200to1500_InclusiveTrigNanoAOD.root'), (QCD_4Jets_Bin_HT_1500to2000, 'histosQCD_HT_1500to2000_InclusiveTrigNanoAOD.root'), (QCD_4Jets_Bin_HT_2000, 'histosQCD_HT_2000_InclusiveTrigNanoAOD.root')]
#QCD_4Jets_Bin_HT_600to800, QCD_4Jets_Bin_HT_800to1000, QCD_4Jets_Bin_HT_1000to1200, QCD_4Jets_Bin_HT_1200to1500,QCD_4Jets_Bin_HT_1500to2000, QCD_4Jets_Bin_HT_2000]
    #output_list = [
#'histosQCD_HT_100to200_InclusiveTrigNanoAOD.root', 
#'histosQCD_HT_200to400_InclusiveTrigNanoAOD.root', 'histosQCD_HT_400to600_InclusiveTrigNanoAOD.root']
#'histosQCD_HT_600to800_InclusiveTrigNanoAOD.root', 'histosQCD_HT_800to1000_InclusiveTrigNanoAOD.root', 'histosQCD_HT_1000to1200_InclusiveTrigNanoAOD.root', 'histosQCD_HT_1200to1500_InclusiveTrigNanoAOD.root', 'histosQCD_HT_1500to2000_InclusiveTrigNanoAOD.root', 'histosQCD_HT_2000_InclusiveTrigNanoAOD.root']
   
    # Create a Pool of processes (defaults to number of CPU cores)
    with multiprocessing.Pool() as pool:
        # Map the function to the list of inputs, running them in parallel
        results = pool.starmap(process_data, inputs_list)
    
    print(f"All results completed.\n")#: {results}")
print("Done.")
'''
# use Parse
